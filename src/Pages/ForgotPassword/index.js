...
import { View, Text, SafeAreaView, StyleSheet, TextInput, TouchableOpacity, 
    ...
    <SafeAreaView style={styles.Container}>
        <LinearGradient style={{flex: 1, height: '100%', width: '100%'}} colors={['rgb(255,199,0)','#ff8d00', 'rgb(255,0,0)']}>
          <ScrollView>
            ...
            <TouchableOpacity style={{justifyContent: 'center', alignItems: 'center'}} onPress={()=>{ForgotPassword(email)}}>
              ...
              width: '91%', justifyContent: 'center', alignItems: 'center', paddingVertical: 8, borderRadius: 8}}>
                {
                  loadingAuth ? <ActivityIndicator size={30} color="#ff8d00"/> : <Text style={{fontSize: 18}}>Recuperar senha</Text>
                }

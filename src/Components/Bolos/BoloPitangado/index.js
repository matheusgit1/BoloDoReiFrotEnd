...
export default function BoloPitangado(){
    ...
    useEffect(()=>{
        ...
        await firestore().collection('bolo_pitangado').onSnapshot(snapshot => {
            const listImage = [];
            snapshot.forEach(doc => {
              //doc.foto == null
                if(doc.id == 'preco'){
                  ...
                  GlobalVars.ValorBoloPitangado = parseFloat(price).toFixed(2);
                }
          ...
          <View>
            <View style={styles.container}>
              <View style={styles.Cab}>
                <Text style={styles.Title}>Bolo Pitangado</Text>
              ...
              <Buttons promo={promotion} screenNavigation="Bolo Pitangado"/>
            </View>
          </View>
        </ScrollView>
    </ScrollView>

...
export default function BoloCacarola(){
        ...
        await firestore().collection('bolo_cacarola').onSnapshot(snapshot => {
          ...
          snapshot.forEach(doc => {
            ...
            if(doc.id == 'preco'){
              ...
              GlobalVars.ValorBoloCacarola = parseFloat(price).toFixed(2);
              //console.log("GlobalVars.ValorBoloCacarola:   " + GlobalVars.ValorBoloCacarola )
            }
          ...
          <View>
            <View style={styles.container}>
              <View style={styles.Cab}>
                <Text style={styles.Title}>Bolo Caçarola</Text>
              ...
              <Buttons promo={promotion} screenNavigation="Bolo Caçarola"/>
            </View>
          </View>
        </ScrollView>
      </ScrollView>

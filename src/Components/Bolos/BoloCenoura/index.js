        ...
        await firestore().collection('bolo_cenoura').onSnapshot(snapshot => {
          ...
          snapshot.forEach(doc => {
            ...
            if(doc.id == 'preco'){
              ...
              setPrice(valor.valor);
              GlobalVars.ValorBoloCenoura = parseFloat(price).toFixed(2);
              //console.log("GlobalVars.BoloCenoura:  "+GlobalVars.BoloCenoura)
            }
        ...
        <ScrollView style={{marginBottom: 5}} showsVerticalScrollIndicator={false}>
          <View>
            <View style={styles.container}>
              ...
              <Buttons promo={promotion} screenNavigation="Bolo de Cenoura"/>
            </View>
          </View>
        </ScrollView>
      </ScrollView>

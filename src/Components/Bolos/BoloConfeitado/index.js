...
export default function BoloConfeitado(){
    ...
    useEffect(()=>{
        ...
        await firestore().collection('bolo_confeitado').onSnapshot(snapshot => {
          const listImage = [];
          ...
          //doc.foto == null
            if(doc.id == 'preco'){
              ...
              GlobalVars.ValorBoloConfeitado = parseFloat(price).toFixed(2);
              //console.log("GlobalVars.ValorBoloConfeitado:  " + GlobalVars.ValorBoloConfeitado);
            }
          ...
          <View>
            <View style={styles.container}>
              <View style={styles.Cab}>
                <Text style={styles.Title}>Bolo Confeitado</Text>
              ...
              <Buttons promo={promotion} screenNavigation="Bolo Confeitado"/>
            </View>
